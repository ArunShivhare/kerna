    ...
    <section className="py-20 px-6 bg-white dark:bg-gray-950">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-10 items-start">
          {/* Contact Info */}
          <div>
            <h3 className="text-xl dark:text-amber-50 font-semibold mb-4">
              Get in Touch
            </h3>

            <p className="text-gray-600 dark:text-gray-300 mb-4">Phone:</p>

            <p className="text-gray-700 dark:text-gray-200">+91 75696 12318</p>
            ...
            <p className="text-gray-700 dark:text-gray-200">
              Marripalem, Visakhapatnam, Andhra Pradesh
            </p>

            <p className="mt-2 text-gray-600 dark:text-gray-300">
              <a
                href="https://maps.app.goo.gl/GSnQY11G6ARbB3N29"
                target="_blank"
